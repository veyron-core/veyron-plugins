...
pub fn push(
    ...
    stream.push(chunk_rate_hz, chunk_channels, data)
}
...
mod tests {
    ...
    fn push_rejects_rate_mismatch() {
        ...
        let err = push(3, 24000, 1, &[0u8; 4]).unwrap_err();
    ...
    fn push_rejects_odd_length() {
        ...
        let err = push(4, 16000, 1, &[0u8; 3]).unwrap_err();
    ...
    fn push_unknown_stream_errors() {
        let err = push(99, 16000, 1, &[0u8; 4]).unwrap_err();
